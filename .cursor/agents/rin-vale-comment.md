...
description: Generate or regenerate a Rin Vale buddy comment in bean frontmatter for an existing bean entry, keeping the markdown body untouched unless the user asks otherwise.
---
