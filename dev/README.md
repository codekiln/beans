...
- Worktrees should live under `/workspaces/beans-worktrees` so they persist and stay inside the Codespaces workspace.
- Use the helper script to add/list/prune/remove worktrees:
  - `dev/worktree add feat/my-branch`
  - `dev/worktree list`
  - `dev/worktree prune`
  - `dev/worktree remove /workspaces/beans-worktrees/feat/my-branch`
